  ...
  <div class="banner-1">
    ...
    >
      ...
      >
        ...
        <li class="menu-button"><a href="#work" v-smooth-scroll>Music</a></li>
        <li class="menu-button">
          <a href="#testimonial" v-smooth-scroll>Media</a>
        </li>
  ...
  <div class="banner-2 space-y-10 pb-20" id="work">
    ...
    <div class="card">
      <div class="space-y-5 py-8 px-8 md:py-16 md:px-20 md:w-1/2">
        ...
        <p class="font-work_sans pr-12">
          ...
          supply and just sucked it all up! He's currently 20,000 feet in the air, if anyone has
    ...
    <div class="card">
      <div class="space-y-5 py-8 px-8 md:py-16 md:px-20 md:w-1/2">
        ...
        <p class="font-work_sans pr-12">
          We have lots of live tracks that the band should sift through and release on bandcamp probably.
        </p>
        <button class="text-sky-800 font-bold text-2xl tracking-wider">
          Coming Soon...
        </button>
